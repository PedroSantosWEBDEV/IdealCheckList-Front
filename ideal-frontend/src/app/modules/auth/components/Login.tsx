  ...
  return (
    ...
    >
      ...
      <Link to='/' className='mb-12'>
            <img alt='Logo' src={toAbsoluteUrl('/media/logos/ideal-logo.png')} className='h-250px' />
          </Link>
        <h1 className='text-dark fw-bolder mb-3'>Fazer Login</h1>
      ...
      {formik.status ? (
        ...
        <div className='mb-10 bg-light-info p-8 rounded'>
          <div className='text-info'>
             Use a conta <strong>admin@demo.com</strong> e a senha <strong>demo</strong> para
             continuar.
          </div>
        </div>
      )}
